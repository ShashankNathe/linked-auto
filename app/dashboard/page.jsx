      ...
      <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2">
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
          <Card className="sm:col-span-2" x-chunk="dashboard-05-chunk-0">
            ...
            <CardFooter>
              <Link
                href={`https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=86zarhofajs6if&redirect_uri=http://localhost:3000&state=foobar&scope=profile%20email%20w_member_social`}
              >
                Connect Linkedin
              </Link>
            </CardFooter>
